...
function onChangedRegion(key, current_region, old_region)
    print("[INFO] Region changed from " .. old_region .. " to " .. current_region)

    -- Split region string and modify CELESTE_PLAY_STATE object
    local t = {}
    for str in string.gmatch(current_region, "([^;]+)") do
        table.insert(t, str)
    end
    CELESTE_PLAY_STATE.IsOverworld = tonumber(t[1])
    CELESTE_PLAY_STATE.Level = tonumber(t[2])
    CELESTE_PLAY_STATE.Side = tonumber(t[3])
    CELESTE_PLAY_STATE.Room = t[4]

    print("[DEBUG] IsOverworld: " .. CELESTE_PLAY_STATE.IsOverworld)
    print("[DEBUG] Level: " .. CELESTE_PLAY_STATE.Level)
    print("[DEBUG] Side: " .. CELESTE_PLAY_STATE.Side)
    print("[DEBUG] Room: " .. CELESTE_PLAY_STATE.Room)
